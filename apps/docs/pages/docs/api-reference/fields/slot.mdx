...
<Callout type="info">
  Drag-and-drop in the outline does not respect this prop. Prefer the [`allow`
  field parameter](#allow), which is enforced everywhere.
</Callout>
...
<Callout type="info">
  Drag-and-drop in the outline does not respect this prop. Prefer the
  [`disallow` field parameter](#disallow), which is enforced everywhere.
</Callout>
